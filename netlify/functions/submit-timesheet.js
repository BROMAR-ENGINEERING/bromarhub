// Submit Timesheet Function - V1.23 - 2026-05-19 - /netlify/functions/submit-timesheet.js
      ...
      try {
        ...
        if (uploadErr) {
          ...
          await supabase
            ...
            .then(({ error }) => {
              if (error && !/column.*pdf_path/i.test(error.message)) {
                console.warn('Could not update pdf_path:', error.message);
              }
            });
        }
      } catch (storageErr) {
